# My take on Cory House's [Building Applications in React and Redux](http://www.pluralsight.com/author/cory-house) on Pluralsight, using typescript and getting a 100% code coverage from jest tests
